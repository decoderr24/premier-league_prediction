...
# --- PERUBAHAN 2: Menghapus class_weight='balanced' untuk eksperimen ---
model = RandomForestClassifier(n_estimators=200, random_state=42) # Dihapus: class_weight='balanced'
...
def predict_match(home_team_input, away_team_input, passing_df, historical_df, model):
    ...
    # --- PERUBAHAN 1: Standarisasi nama tim di awal ---
    name_map = {
        "Man City": "Manchester City", "Man Utd": "Man United", "Spurs": "Tottenham"
        # Tambahkan nama lain jika perlu, misal "Nott'ham Forest": "Nott'm Forest"
    }
    ...
    def avg_pass_perc(team_name, passing_stats_df):
        # Gunakan nama yang sudah distandarisasi
        team_df = passing_stats_df[passing_stats_df["Squad"].str.contains(team_name, case=False, na=False)]

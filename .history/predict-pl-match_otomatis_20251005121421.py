...
# Mengabaikan peringatan teknis dari Pandas yang tidak krusial
...
# ================================
# Ganti nama tim di bawah ini untuk memprediksi pertandingan lain
predict_match("Wolves", "Brighton", passing_df, hist_df, model)

...
# ================================
# 3️⃣ FEATURE ENGINEERING TINGKAT LANJUT: "TEAM FORM" (VERSI PERBAIKAN FINAL)
# ================================
...
rolling_stats.rename(columns={
    ...
    'SOT_For': 'AvgSOT_L5', 'CornersFor': 'AvgCorners_L5', 'FoulsCommitted': 'AvgFouls_L5',
...
# Buat dataframe statistik terpisah untuk Home dan Away SEBELUM di-merge
...
# Merge satu per satu dengan dataframe yang namanya sudah benar
...
def predict_match(home_team_input, away_team_input, historical_df, model):
    ...
    form_values = [
        ...
        home_form['AvgSOT_L5'].values[0], home_form['AvgCorners_L5'].values[0], home_form['AvgFouls_L5'].values[0], home_form['AvgYellows_L5'].values[0],
        away_form['AvgGoalsFor_L5'].values[0], away_form['AvgGoalsAgainst_L5'].values[0], away_form['AvgShotsFor_L5'].values[0],
        away_form['AvgSOT_L5'].values[0], away_form['AvgCorners_L5'].values[0], away_form['AvgFouls_L5'].values[0], away_form['AvgYellows_L5'].values[0]
    ]

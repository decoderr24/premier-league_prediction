...
# ================================
# Bagian 1 & 2 (Memuat & Menyesuaikan Data) - Tidak Berubah
# ================================
...
# ================================
# Bagian 3 (Feature Engineering 'Team Form') - Tidak Berubah
# ================================
...
# ================================
# Bagian 4 (Feature Engineering H2H) - DENGAN PERBAIKAN SYNTAX
# ================================
...
# ================================
# Bagian 5, 6, 7 (Training, Prediksi, Contoh) - Tidak Berubah
# ================================
...
model = xgb.XGBClassifier(
    ...
    colsample_bytree=0.8, gamma=0.1, random_state=42, objective='multi:softprob',

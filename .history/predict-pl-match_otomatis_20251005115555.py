...
try:
    schedule_df = pd.read_csv("epl-training.csv")
    print(f"✅ Berhasil memuat {len(schedule_df)} pertandingan dari 'epl-training.csv'")
except FileNotFoundError:
    print("❌ Gagal: File 'epl-training.csv' tidak ditemukan. Prediksi massal dibatalkan.")
